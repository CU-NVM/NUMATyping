...
experiment_folder = "./Output/Histogram/"
output_filename = "histogram_experiments.csv"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Run histogram experiment and append results to CSV.")
