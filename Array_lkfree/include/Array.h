...
#pragma once 
/*! \file Array.hpp
 * \brief Array program which allows for testing of an arraygg
 * \author Kidus
 * \date 2026
 *
 */
...
void numa_array_init(int tid, int num_threads, std::string DS_config, int64_t array_size, int node, int num_arrays, int duration, int interval);
