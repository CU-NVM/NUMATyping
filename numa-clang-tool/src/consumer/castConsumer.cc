#include "castConsumer.h"
#include "../transformer/CastNumaAlloc.h"
#include <fstream>
#include <string>
...
void CastConsumer::HandleTranslationUnit(clang::ASTContext &context){
    llvm::outs() <<"Calling CastNumaAlloc from CastConsumer\n";
    CastNumaAlloc CastNumaAlloc(context, rewriter);
    CastNumaAlloc.start();
