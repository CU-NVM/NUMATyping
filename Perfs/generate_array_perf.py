...
# Perf run
# ----------------------------------------------------
def perf_array_experiment(output_dir: Path) -> None:
    ...
    perf_output = output_dir / f"{th_config}_{ds_config}_{n}_{s}_perf.data"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Run array flamegraph experiment.")
    ...
    if args.AN == 1:
        output_dir = ROOT / "Perfs" / "AN_on" / "array"
    else:
        output_dir = ROOT / "Perfs" / "AN_off" / "array"
    ...
    # 3) Run FlameGraph
    print("Running array + FlameGraph...")
    perf_array_experiment(output_dir)
